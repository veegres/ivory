...
import {CancelIconButton, InfoIconButton, PlayIconButton, QueryParamsIconButton} from "../../../shared/component/button/IconButtons"
import {FixedInputs} from "../../../shared/component/input/FixedInputs"
import {Feature} from "../../feature"
import {ManageAccess} from "../../management/component/ManageAccess"
import {Connection, VarietyType} from "../api/type"
...
export function QueryTemplateWrapper(props: Props) {
    ...
    function renderRunButton() {
        return !checkView[ViewCheckType.RUN] ? (
            <ManageAccess feature={Feature.ManageQueryDbTemplate}>
