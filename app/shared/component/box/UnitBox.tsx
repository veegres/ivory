...
const SX: SxPropsMap = {
    ...
    label: {fontSize: "12px", fontFamily: "monospace", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis"},
    value: {fontSize: "12px", color: "text.secondary", whiteSpace: "nowrap",},
}
