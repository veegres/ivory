			...
			Commands: []keeper.DeploymentCommand{
				{
					...
					Defaults: keeper.DeploymentCommandDefaults{Name: "mongo1", Host: "localhost", SshPort: 22, KeeperPort: 27017, DbPort: 27017},
				},
				{
					Command:  deploySingleHost,
					Defaults: keeper.DeploymentCommandDefaults{Name: "mongo2", Host: "localhost", SshPort: 22, KeeperPort: 27018, DbPort: 27018},
				},
				{
					Command:     deploySingleHost,
					PostScripts: []string{deploySingleHostInitiate},
					Defaults:    keeper.DeploymentCommandDefaults{Name: "mongo3", Host: "localhost", SshPort: 22, KeeperPort: 27019, DbPort: 27019},
				},
			},
		},
	}
