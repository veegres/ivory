...
var ErrKeeperCredentialsRequired = errors.New("keeper credentials are required")
...
var ErrKeeperCredentialsAmbiguous = errors.New("provide either a keeper vault or a username and password, not both")
